...
Para completar a checklist de avaliação de controles, consulte as informações fornecidas no documento de [escopo, objetivos e relatório de avaliação de riscos](https://github.com/querycat/cyber-internal-audit-simulation/blob/main/docs/scope.md). Para mais detalhes sobre cada controle, incluindo o tipo e o propósito, consulte o documento de [categorias de controle](https://github.com/querycat/cyber-internal-audit-simulation/blob/main/docs/control-categories.md). Em seguida, selecione “sim” ou “não” para responder à pergunta: A Botium Toys atualmente possui este controle implementado?
...
| Backups                                                                          |     |     |
| Antivírus                                                                        |     |     |
| Monitoramento e intervenção manual em sistemas legados                           |     |     |
| Criptografia                                                                     |     |     |
| Sistema de gerenciamento de senhas                                               |     |     |
| Fechaduras (escritório, loja, depósito)                                          |     |     |
| CFTV                                                                             |     |     |
...
| Boas práticas                                                                                        | Sim | Não |
| :--------------------------------------------------------------------------------------------------- |:---:|:---:|
| Dados pessoais de clientes do Brasil mantidos privados e seguros.                                    |     |     |
